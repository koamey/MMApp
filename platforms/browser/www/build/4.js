...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CancelMealPageModule", function() { return CancelMealPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cancel_meal__ = __webpack_require__(907);
...
var CancelMealPageModule = (function () {
    function CancelMealPageModule() {
    }
    CancelMealPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cancel_meal__["a" /* CancelMealPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__cancel_meal__["a" /* CancelMealPage */]),
            ],
        })
    ], CancelMealPageModule);
    return CancelMealPageModule;
}());

//# sourceMappingURL=cancel-meal.module.js.map
...
;(function (global, factory) {
    true ? factory(__webpack_require__(779)) :
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CancelMealPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_moment__ = __webpack_require__(779);
 ...
 */
var CancelMealPage = (function () {
    function CancelMealPage(navCtrl, navParams, apiService, util, translate, platform, atrCtrl, ionicApp) {
    ...
    CancelMealPage.prototype.initializeBackButtonCustomHandler = function () {
        var _this = this;
        this.unregisterBackButtonAction = this.platform.registerBackButtonAction(function () {
            _this.customHandleBackButton();
        }, 10);
    };
    CancelMealPage.prototype.customHandleBackButton = function () {
    ...
    CancelMealPage.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.apiService.showCountMeal(this.tokendata, this.customer_id, this.customer_subscription_id).then(function (res) {
            if (res) {
                _this.countMeal1 = res['data'];
            }
            else {
            }
        }).catch(function (e) {
    ...
    CancelMealPage.prototype.ionViewDidLoad = function () {
    };
    CancelMealPage.prototype.Back = function () {
        this.navCtrl.setRoot('DashboardPage');
    };
    CancelMealPage.prototype.radioGroupChange = function (e) {
    ...
    CancelMealPage.prototype.fromSelectdate = function () {
    ...
    CancelMealPage.prototype.toSelectdate = function () {
    ...
    CancelMealPage.prototype.onSubmit = function () {
        var _this = this;
        ...
        var a = __WEBPACK_IMPORTED_MODULE_5_moment___default()(this.fromDate, 'YYYY-MM-DD');
        var b = __WEBPACK_IMPORTED_MODULE_5_moment___default()(this.toDate, 'YYYY-MM-DD');
        ...
        this.apiService.cancelmeal(this.customer_subscription_id, this.customer_id, this.meal_type, this.toDate, this.fromDate).then(function (res) {
    ...
    CancelMealPage.prototype.showConfirmAlert = function () {
    ...
    CancelMealPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-cancel-meal',template:/*ion-inline-start:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/cancel-meal/cancel-meal.html"*/'<ion-header no-border class="dit-type-header cancel-opacity">\n  <ion-navbar>\n    <ion-buttons left>\n      <button ion-button icon-only (click)="Back()">\n        <img src="assets/imgicon/Group_51.svg" class="backWhiteIcon">\n      </button>\n    </ion-buttons>\n    <ion-title text-center>CANCEL MEALS</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content class="main-content cancel-scroll">\n  <div class="screen-heading">\n    <span>Choose</span>\n    <h2>Date & Meal</h2>\n  </div>\n  <div class="choose-cancelmeal">\n    <ion-grid>\n      <ion-row text-center>\n        <ion-col>\n          <label>\n            <h5>CHOOSE DATE/RANGE</h5>\n            <h4>FROM</h4>\n          </label>\n        </ion-col>\n      </ion-row>\n\n      <ion-row>\n        <ion-col col-12 class="text-center">\n          <ion-item>\n            <ion-datetime class="datetime-text-from" displayFormat="DD MMMM YYYY" [min]="today1" [max]="minDate2"\n              [(ngModel)]="selecteddate1" (ngModelChange)="fromSelectdate()"></ion-datetime>\n          </ion-item>\n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col col-12 class="text-center">\n          <label>\n            <h4>TO</h4>\n          </label>\n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col col-12 class="text-center">\n          <ion-item>\n            <ion-datetime class="datetime-text-from" displayFormat="DD MMMM YYYY" [min]="minDate1" [max]="maxDate"\n              [(ngModel)]="selecteddate2" (ngModelChange)="toSelectdate()" [disabled]="selecteddate1==\'\'">\n            </ion-datetime>\n          </ion-item>\n        </ion-col>\n      </ion-row>\n\n      <ion-row>\n        <ion-col col-12 class="text-center">\n          <h5>CHOOSE MEAL TYPE</h5>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n    <div class="cancel-meal-type-color">\n      <ion-list>\n        <ion-row>\n          <!-- for lunch -->\n          <ion-col col-12 *ngIf="mealType==\'Lunch\'" class="mealtype-checked">\n              <ion-radio type="radio" mode="md" value="Lunch" name="lunch" (click)="radioGroupChange(\'Lunch\')" [checked]="rdDefaultLunch" [disabled]="toDate==\'\'"></ion-radio>\n           <!--  <input type="radio" [checked]="rdDefaultLunch" id="lunch" name="lunch" mode="md" value="Lunch"\n              (click)="radioGroupChange(\'Lunch\')" [disabled]="toDate==\'\'"/> -->\n            <label *ngIf="toDate==\'\'">Lunch</label>\n            <label (click)="radioGroupChange(\'Lunch\')" *ngIf="toDate!=\'\'">Lunch</label>\n          </ion-col>\n          <!-- for dinner -->\n          <ion-col col-12 *ngIf="mealType==\'Dinner\'" class="mealtype-checked">\n             <ion-radio type="radio" mode="md" [checked]="rdDefaultDinner" value="Dinner" name="dinner" (click)="radioGroupChange(\'Dinner\')" [disabled]="toDate==\'\'"></ion-radio>\n           <!--  <input type="radio" [checked]="rdDefaultDinner" id="dinner" name="dinner" mode="md" value="Dinner"\n              (click)="radioGroupChange(\'Dinner\')" [disabled]="toDate==\'\'"/> -->\n            <label *ngIf="toDate==\'\'">Dinner</label>\n            <label (click)="radioGroupChange(\'Dinner\')" *ngIf="toDate!=\'\'">Dinner</label>\n          </ion-col>\n\n          <!-- for both -->\n\n          <ion-col col-6 *ngIf="mealType==\'Both\'" class="mealtype-checked">\n             <ion-radio type="radio" mode="md" value="Lunch" name="lunch" (click)="radioGroupChange(\'Lunch\')" [disabled]="toDate==\'\'" [checked]="rdDefaultLunch"></ion-radio>\n            <!-- <input type="radio" [checked]="rdDefaultLunch" id="lunch" name="lunch" mode="md" value="Lunch" (click)="radioGroupChange(\'Lunch\')" [disabled]="toDate==\'\'"/> -->\n          <label *ngIf="toDate==\'\'">Lunch</label>\n            <label (click)="radioGroupChange(\'Lunch\')" *ngIf="toDate!=\'\'">Lunch</label>\n          </ion-col>\n\n          <ion-col col-6 *ngIf="mealType==\'Both\'" class="mealtype-checked">\n             <ion-radio type="radio" mode="md" value="Dinner" name="Dinner" (click)="radioGroupChange(\'Dinner\')" [disabled]="toDate==\'\'" [checked]="rdDefaultDinner"></ion-radio>\n           <!--  <input type="radio" [checked]="rdDefaultDinner" id="dinner" name="dinner" mode="md" value="Dinner"\n              (click)="radioGroupChange(\'Dinner\')" [disabled]="toDate==\'\'"/> -->\n             <label *ngIf="toDate==\'\'">Dinner</label>\n            <label (click)="radioGroupChange(\'Dinner\')" *ngIf="toDate!=\'\'">Dinner</label>\n          </ion-col>\n\n        </ion-row>\n\n      </ion-list>\n    </div>\n    <div class="text-center">\n      <p class="remain-count">Remaining <span>{{countMeal}} Meals</span> Cancellations\n      </p>\n      <p class="footer-contents">\n        <span>*</span>The action of cancelling meals can not be reverted or changed later. please make sure before\n        confirmation.\n      </p>\n\n\n    </div>\n\n    <ion-grid class="footer-color">\n      <ion-row>\n        <ion-col>\n          <button class="button-class-cancel" type="submit" id="input_submit" block (click)="onSubmit()"\n            [style.background]="submitButton" [style.color]=\'submitButtoncolor\'>\n            Confirm Cancellation\n          </button>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/cancel-meal/cancel-meal.html"*/,
        }),
    ...
    return CancelMealPage;
}());

//# sourceMappingURL=cancel-meal.js.map
