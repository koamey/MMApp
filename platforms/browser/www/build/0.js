...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__orders_history__ = __webpack_require__(941);
...
var OrdersHistoryPageModule = (function () {
    ...
    OrdersHistoryPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__orders_history__["a" /* OrdersHistoryPage */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__orders_history__["a" /* OrdersHistoryPage */]),
...
//# sourceMappingURL=orders_history.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return OrdersHistoryPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(779);
...
var OrdersHistoryPage = (function () {
    function OrdersHistoryPage(apiService, nav, historyService) {
    ...
    OrdersHistoryPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.historyService.getItems().then(function (items) {
            _this.orders = items;
        }, function () { });
    };
    OrdersHistoryPage.prototype.showOrder = function (order) {
        this.nav.setRoot('OrderViewPage', { order: order });
    };
    OrdersHistoryPage.prototype.stringAsDate = function (v) {
        return __WEBPACK_IMPORTED_MODULE_4_moment__(v).toDate();
    };
    OrdersHistoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/personal/orders_history/orders_history.html"*/'<ion-header>\n    <ion-navbar custom-navbar>\n        <button ion-button menuToggle *ngIf="loggedIn">\n            <ion-icon name="menu"></ion-icon>\n        </button>\n        <ion-title>\n            {{ \'order.history\' | translate }}\n        </ion-title>\n    </ion-navbar>\n</ion-header>\n\n<ion-content>\n    <ion-card *ngFor="let order of orders" (click)="showOrder(order)">\n        <ion-item>\n            <h2 [translate]="\'order.id\'" [translateParams]="{ id: order.id }"></h2>\n            <p>{{ order.address }}</p>\n            <p>{{ stringAsDate(order.created_at) | date: date_format }}</p>\n        </ion-item>\n        <ion-item>\n            <p *ngIf="order.restaurant && multiR">\n                {{ order.restaurant.name }}\n            </p>\n            <p><b>{{ order.total_with_tax | ecurrency }}</b></p>\n        </ion-item>\n    </ion-card>\n</ion-content>'/*ion-inline-end:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/personal/orders_history/orders_history.html"*/
        }),
