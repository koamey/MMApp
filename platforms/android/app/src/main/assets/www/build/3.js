...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news_detail__ = __webpack_require__(928);
...
var NewsDetailPageModule = (function () {
    ...
    NewsDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__news_detail__["a" /* NewsDetailPage */]),
...
//# sourceMappingURL=news_detail.module.js.map
...
var NewsDetailPage = (function () {
    function NewsDetailPage(navParams, sanitizer, nav, api) {
    ...
    NewsDetailPage.prototype.stringAsDate = function (v) {
        return __WEBPACK_IMPORTED_MODULE_4_moment__(v).toDate();
    };
    NewsDetailPage.prototype.getNewsContent = function () {
        return this.sanitizer.bypassSecurityTrustHtml(this.item.full_text);
    };
    NewsDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'news-detail',template:/*ion-inline-start:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/news/news_detail/news_detail.html"*/'<ion-header>\n	<ion-navbar>\n		<ion-title>{{ item.title }}</ion-title>\n	</ion-navbar>\n</ion-header>\n<ion-content class="home">\n	<div class="default-list">\n		<div class="list-item -article">\n			<div class="img-wrapper">\n				<img [src]="item.image_url" *ngIf="item.image_url">\n			</div>\n			<div class="item-text-wrapper">\n				<div padding>\n					<h2>{{ item.title }}</h2>\n					<div class="date">{{ stringAsDate(item.created_at) | date: date_format }}</div>\n					<br>\n					<div>{{ item.announce }}</div>\n					<div [innerHTML]="getNewsContent()"></div>\n				</div>\n			</div>\n		</div>\n	</div>\n</ion-content>'/*ion-inline-end:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/news/news_detail/news_detail.html"*/
        }),
