...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__news_feed__ = __webpack_require__(929);
...
var NewsFeedPageModule = (function () {
    ...
    NewsFeedPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__news_feed__["a" /* NewsFeedPage */]),
...
//# sourceMappingURL=news_feed.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(779);
...
var NewsFeedPage = (function () {
    function NewsFeedPage(nav, apiService) {
        this.nav = nav;
    ...
    NewsFeedPage.prototype.populateList = function () {
        var _this = this;
        this.page = 1;
        this.items = [];
        this.apiService.getNews(this.page, this.apiService.getUserData().city_id).then(function (response) {
            _this.items = response.json();
        });
    };
    NewsFeedPage.prototype.showTracker = function () {
        this.nav.setRoot('Tracker', { tracker: this.tracker });
    };
    NewsFeedPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.populateList();
        this.apiService.orderTracker().subscribe(function (data) {
            _this.tracker = data;
        });
    };
    NewsFeedPage.prototype.showDetails = function (item) {
    ...
    NewsFeedPage.prototype.stringAsDate = function (v) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__(v).toDate();
    };
    NewsFeedPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'news-feed',template:/*ion-inline-start:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/news/news_feed/news_feed.html"*/'<ion-header>\n	<ion-navbar>\n		<button ion-button menuToggle *ngIf="loggedIn">\n			<ion-icon name="menu"></ion-icon>\n		</button>\n		<ion-title>{{ \'news.title\' | translate }}</ion-title>\n	</ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div padding *ngIf="tracker.order">\n    <div class="pending-order" tappable (click)="showTracker()">\n      You have the pending order, click here to view details\n      <ion-icon name="arrow-forward"></ion-icon>\n    </div>\n  </div>\n	<ion-card *ngFor="let item of items" tappable (click)="showDetails(item)" >\n		<ion-item text-wrap>\n			<ion-avatar item-left>\n				<img [src]="item.image_url" *ngIf="item.image_url">\n			</ion-avatar>\n			<h2>{{ item.title }}</h2>\n			<p>\n				<small>{{ stringAsDate(item.created_at) | date: date_format }}</small>\n			</p>\n			<p>{{ item.announce }}</p>\n		</ion-item>\n	</ion-card>\n</ion-content>\n'/*ion-inline-end:"/Users/harish/Documents/Development/Mummymeals/git/mummymeals_app/src/pages/news/news_feed/news_feed.html"*/
        }),
